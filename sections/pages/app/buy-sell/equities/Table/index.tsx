...
export const Table = () => {
  ...
  const [activeIndexDropdown, setActiveIndexDropdown] = useState(navigation[1]);
  ...
  useEffect(() => {
    fetchOrders();
  }, [stockWalletAmount, cryptoWalletAmount, sortBy, sortAsceding]);

  const handleFetchWalletAmount = useCallback(() => {
    handleFetchStockWallet();
    handleFetchCryptoWallet();
  }, [handleFetchStockWallet, handleFetchCryptoWallet]);
